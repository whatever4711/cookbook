...
\include{wedding_recipes/Ariane_RatatouilleMitTofu}
\include{wedding_recipes/David_ScotchPancakes}
\include{wedding_recipes/MartinLinus_Risotto}
\include{wedding_recipes/Heike_GratinierterSpargel}
\include{wedding_recipes/Sebastian_KokosCurrySueskartoffeln}
\include{wedding_recipes/Marie_RoteBeeteSuesskartoffelgratin}
\include{wedding_recipes/LinusMartin_Carbonara}
\include{wedding_recipes/Stefan_Pommes}
\include{wedding_recipes/Grossmanns_Kartoffelpuffer}
\include{wedding_recipes/Sebastian_Couscoussalat}
\include{wedding_recipes/Andreas_FlambierteFruechte}
...
\end{figure}
\include{wedding_recipes/Monika_Geschnetzeltes}
\include{wedding_recipes/Lars_SchweizerLendentopf}
\include{wedding_recipes/Sebastian_Beegel}
\include{wedding_recipes/Chris_EisbeinGebraten}
\include{wedding_recipes/Sina_SpiegeleierMitBacon}
\include{wedding_recipes/Sven_HausgemachteTagliatelleMitRinderfiletspitzen}
\include{wedding_recipes/Petr_Borschtsch}
\include{wedding_recipes/Udo_Puten_Gemuese_Curry}
\include{wedding_recipes/Daniel_Lasagne}
\include{wedding_recipes/Marie_KuerbisApfelCurryMitEntenbrust}
\include{wedding_recipes/Sebastian_ScharfeErdnussCurrysosse}
\include{wedding_recipes/Lisa_IngwerlachsMitBlattspinat}
...
\include{wedding_recipes/Marie_Sachertorte}
\include{wedding_recipes/Linus_Bierkuchen}
\include{wedding_recipes/Marie_FantaschnittenMitPfirsichschmand}
\include{wedding_recipes/Ilka_Cranberrykuchen}
\include{wedding_recipes/Marie_Apfelmuffins}
